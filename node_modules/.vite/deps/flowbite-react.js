...
var processChildren = (children, outline, pill) => {
  return import_react7.Children.map(children, (child, index) => {
    if ((0, import_react7.isValidElement)(child)) {
      const positionInGroupProp = child.type == Button ? { positionInGroup: determinePosition(index, import_react7.Children.count(children)) } : {};
...
var DropdownComponent = ({
  ...
  const handleSelect = (0, import_react33.useCallback)((index) => {
